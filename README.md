...
- Feature: Combine `is_analysing` and `is_broadcasting` flags. These are a hold over from early development and arch patterns.
...
- Improve: Cliff script, better changelogs, excluded commits.
